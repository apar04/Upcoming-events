...
const PaperPresentation = () => {
    ...
    const eventDetails = {
        ...
        executiveMembers: ["David Miller", "Emma Clark", "Sophia Rodriguez"],
        events: [
            { name: "Research Paper Contest", time: "10:00 AM - 12:00 PM", venue: "Seminar Hall", incharge: "Dr. Michael Brown" },
            { name: "Technical Writing Workshop", time: "1:00 PM - 3:00 PM", venue: "Room 202", incharge: "Prof. Jennifer Wilson" },
            { name: "Presentation Skills Training", time: "4:00 PM - 6:00 PM", venue: "Main Auditorium", incharge: "Mr. Thomas Anderson" }
        ]
    };
