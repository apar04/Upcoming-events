...
const Codethon = () => {
    ...
    const eventDetails = {
        title: "👨‍💻 Codethon",
        date: "April 5, 2025",
        coordinator: "Dr. Mark Anderson",
        executiveMembers: ["Sophia Carter", "David Harris", "Emma Thompson"],
        events: [
            { name: "Algorithm Challenge", time: "9:00 AM - 11:00 AM", venue: "Lab 101", incharge: "Prof. Lisa Green" },
            { name: "Debugging Contest", time: "12:00 PM - 2:00 PM", venue: "Lab 202", incharge: "Dr. Richard Miles" },
            { name: "Speed Coding", time: "3:00 PM - 5:00 PM", venue: "Main Hall", incharge: "Ms. Olivia Bennett" }
        ]
    };
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url(' codethon copy.avif')",
