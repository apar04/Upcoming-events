...
const Hackathon = () => {
    ...
    const eventDetails = {
        title: "💻 Hackathon",
        date: "April 2, 2025",
        coordinator: "Dr. Mark Evans",
        executiveMembers: ["David Smith", "Emma Brown", "Sophia Wilson"],
        events: [
            { name: "Idea Pitching", time: "9:00 AM - 10:30 AM", venue: "Hall A", incharge: "Dr. Kevin Adams" },
            { name: "Coding Challenge", time: "11:00 AM - 6:00 PM", venue: "Lab 101", incharge: "Ms. Olivia Scott" },
            { name: "Final Presentation", time: "7:00 PM - 9:00 PM", venue: "Main Auditorium", incharge: "Mr. Daniel Lee" }
        ]
    };
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url('hackthon copy.avif')",
