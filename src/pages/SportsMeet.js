...
const SportsMeet = () => {
    ...
    const eventDetails = {
        ...
        executiveMembers: ["Ethan Cooper", "Mia Johnson", "Noah Smith"],
        events: [
            { name: "100m Sprint", time: "9:00 AM - 10:00 AM", venue: "Main Track", incharge: "Coach Daniel Lee" },
            { name: "Football Finals", time: "11:00 AM - 1:00 PM", venue: "Football Ground", incharge: "Mr. Ryan Adams" },
            { name: "Basketball Championship", time: "3:00 PM - 5:00 PM", venue: "Indoor Arena", incharge: "Ms. Emily Roberts" }
        ]
    };
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: "url('sportsmeet.avif')",
                        ...
                        >
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    onMouseEnter={(e) => (e.target.style.backgroundColor = "#ffffff", e.target.style.color = "#28a745")}
